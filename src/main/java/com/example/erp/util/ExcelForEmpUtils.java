                            ...
                            case 1:
                                ...
                                switch (k) {
                                    ...
                                    case 6:
                                        ...
                                        break;
                                    case 7:
                                        int nationIndex = allNations.indexOf(new Nation().setName(cellValue));
                                        nation = new Nation();
                                        nation.setId(allNations.get(nationIndex).getId());
                                    ...
                                    case 8:
                                        ...
                                        break;
                                    case 9:
                                        int politicstatusIndex = allPoliticsstatus.indexOf(new PoliticsStatus().setName(cellValue));
                                        politicsStatus = new PoliticsStatus();
                                        politicsStatus.setId(allPoliticsstatus.get(politicstatusIndex).getId());
                                    ...
                                    case 11:
                                        ...
                                        break;
                                    case 12:
                                        int departmentIndex = allDepartments.indexOf(new Department().setName(cellValue));
                                        department = new Department();
                                        department.setId(allDepartments.get(departmentIndex).getId());
                                        employee.setDepartment(department);
                                        break;
                                    case 13:
                                        int jobLevelIndex = allJobLevels.indexOf(new JobLevel().setName(cellValue));
                                        jobLevel = new JobLevel().setId(allJobLevels.get(jobLevelIndex).getId());
                                        employee.setJobLevel(jobLevel);
                                        break;
                                    case 14:
                                        int positionIndex = allPositions.indexOf(new Position().setName(cellValue));
                                        position = new Position().setId(allPositions.get(positionIndex).getId());
